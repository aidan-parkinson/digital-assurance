...
Edge devices deployed on private networks may connect securely to publicly exposed devices using the transport layer security protocol over a Network Address Translation (NAT) gateway that restricts inbound connections.
